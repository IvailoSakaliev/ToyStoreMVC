...
namespace ProjectToyStore.Servise.ProjectServise
{
    public class EmailServises : GenericServise<Login>
    {
        ...
        private void SendRestorPasswordEmail()
        {
            ...
            _message.Body = "Please enter link to restor your password in StudentSystem http://wwww.vavilonci.com/Login/EnableAccount/" + _userID;
        ...
        private void SendConfirmEmail()
        {
            ...
            _message.Body = "Please to confirm your registration in Vavilonci http://wwww.vavilonci.com/Login/EnableAccount/" + _userID;
            _message.To.Add(_userEmail);
            _smtpClient.Send(_message);
        }
